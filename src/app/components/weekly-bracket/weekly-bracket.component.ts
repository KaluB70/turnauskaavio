...
@Component({
  ...
  template: `
      <div class="space-y-6">
          ...
          <div class="bg-blue-600 text-white p-4 rounded-lg">
              <div class="flex justify-between items-center">
                  <div>
                      <h2 class="text-xl font-semibold">🎯 Viikkokisat -
                          Viikko {{ weeklyTournamentService.weekNumber }}</h2>
                  ...
                  <div class="text-right">
                      ...
                      <div class="text-sm text-blue-100">{{ weeklyTournamentService.gameMode }} -
                          BO{{ weeklyTournamentService.bestOfLegs }}
                      </div>
                  </div>
              </div>
          </div>
          ...
          <div *ngIf="weeklyTournamentService.currentPhase === 'group' || weeklyTournamentService.currentPhase === 'playoff'">
              ...
              <div *ngIf="weeklyTournamentService.tournamentType === 'round-robin'"
                  ...
                  <div class="overflow-x-auto">
                      <table class="standings-table w-full">
                          ...
                          <tr class="bg-gray-50">
                              ...
                              <th *ngIf="weeklyTournamentService.players.length > 3"
                          ...
                          <tr *ngFor="let standing of getSortedStandings(); let i = index"
                              ...
                              <td *ngIf="weeklyTournamentService.players.length > 3"
              ...
              <div *ngIf="weeklyTournamentService.tournamentType === 'group-based'"
                      ...
                      <div class="overflow-x-auto">
                          <table class="standings-table w-full">
                              ...
                              <tr class="bg-gray-50">
                                  ...
                                  <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">Pelaaja
                                  </th>
                              ...
                              <tr *ngFor="let standing of getGroupStandings(group); let i = index"
                                  ...
                                  <td class="px-3 py-2 text-center text-sm">{{ standing.wins }}-{{ standing.losses }}
                                  </td>
                                  ...
                                  <td class="px-3 py-2 text-center text-sm">
                                      <span *ngIf="i === 0"
                                            class="text-xs bg-green-600 text-white px-2 py-1 rounded-full">Finaaliin</span>
                                      <span *ngIf="i === 1"
                                            class="text-xs bg-yellow-600 text-white px-2 py-1 rounded-full">Karsinta</span>
                                  </td>
                              </tr>
                              </tbody>
                          </table>
      ...
      <!-- Playoff Phase Info -->
      <div *ngIf="weeklyTournamentService.currentPhase === 'playoff'"
      ...
      <!-- Final Phase Info -->
      <div *ngIf="weeklyTournamentService.currentPhase === 'final'"
      ...
      <div class="bg-white p-6 rounded-lg shadow">
          ...
          <!-- Round robin matches (also handles finals that are NOT 3-way) -->
          <div *ngIf="weeklyTournamentService.tournamentType === 'round-robin' ||
              (weeklyTournamentService.currentPhase !== 'group' && !weeklyTournamentService.is3WayFinal())">
          ...
          <!-- 3-way Final Display (separate section) -->
          <div *ngIf="weeklyTournamentService.currentPhase === 'final' && weeklyTournamentService.is3WayFinal()"
               class="mt-4 p-4 bg-green-50 rounded-lg border-2 border-green-300">
              <h4 class="font-semibold mb-3 text-green-700">🏆 3-way Finaali</h4>
              <div class="text-center text-sm text-gray-600 mb-3">
                  Kaikki kolme pelaajaa pelaavat samassa ottelussa
              </div>

              <!-- Show current match if it's ongoing -->
              <div *ngIf="weeklyTournamentService.currentMatch && !weeklyTournamentService.currentMatch.isComplete"
                   class="text-center text-amber-600 font-medium mb-2">
                  ⚡ Käynnissä - katso nykyinen ottelu yläpuolelta
              </div>

              <!-- Show result if completed -->
              <div *ngIf="weeklyTournamentService.currentMatch && weeklyTournamentService.currentMatch.isComplete"
                   class="text-center">
                  <div class="font-medium mb-2">Ottelu päättynyt!</div>
                  <div class="text-green-600 font-bold">
                      Voittaja: {{ weeklyTournamentService.getPlayerName(weeklyTournamentService.currentMatch.winner!) }}
                  </div>
              </div>
          </div>
      </div>
      ...
      <div class="bg-green-100 p-4 rounded-lg">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              <div>
                  ...
                  <div class="text-lg font-bold text-green-600">{{ weeklyTournamentService.players.length * 2.5 }}€
                  </div>
              </div>
              <div>
