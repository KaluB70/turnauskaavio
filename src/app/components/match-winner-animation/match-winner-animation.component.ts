...
export class MatchWinnerAnimationComponent implements OnInit, OnDestroy {
  ...
  continueToNext(): void {
    // Hide the animation
    this.tournamentService.showMatchVictoryAnimation = false;
