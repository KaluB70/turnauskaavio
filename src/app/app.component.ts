...
import { WeeklyPlayerRegistrationComponent } from './components/weekly-player-registration/weekly-player-registration.component';
    ...
    <div class="container mx-auto px-4 py-8">
      ...
      <div *ngIf="!tournamentService.isStarted && !weeklyTournamentService.isStarted" class="mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div class="bg-blue-50 p-6 rounded-lg border-2 border-blue-200 hover:border-blue-400 transition-colors cursor-pointer"
            ...
            <ul class="text-xs text-gray-600 space-y-1">
              ...
              <li>• 6+ pelaajaa: 2 lohkoa → lohkovoittajat + karsinta finaaliin</li>
          ...
          <div class="bg-gray-50 p-6 rounded-lg border-2 border-gray-200 hover:border-gray-400 transition-colors cursor-pointer"
            ...
            <h2 class="text-xl font-semibold mb-3 text-gray-800">⚔️ Pudotusturnaaus</h2>
      ...
      <!-- Standings View -->
      <div *ngIf="selectedTournamentType === 'standings'">
      ...
      <div *ngIf="selectedTournamentType === 'elimination'">
        <h1 class="text-3xl font-bold text-center mb-8">Pudotusturnaaus</h1>
        ...
        <div *ngIf="tournamentService.isStarted">
          ...
          <div class="mt-8 text-center" *ngIf="!tournamentService.currentMatch && !tournamentService.showVictoryAnimation">
            <button
              (click)="resetToHome()"
              class="bg-gray-600 text-white py-2 px-6 rounded-md hover:bg-gray-700">
              ← Takaisin päävalikkoon
...
export class AppComponent {
  selectedTournamentType: 'weekly' | 'elimination' | 'standings' | null = null;
